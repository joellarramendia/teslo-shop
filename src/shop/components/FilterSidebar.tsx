...
export const FilterSidebar = () => {
    ...
    const handlSizeChange = (size: string) => {
        ...
        if (newSizes.length > 0) {
            ...
            newParams.delete('sizes') //limpia el parametro si no hay tallas seleccionadas
        }
    ...
    return (
        <div className="w-64 space-y-6">
                ...
                <div className="grid grid-cols-3 gap-2">
                    {sizes.map((size) => (
                        <Button
                            ...
                            size="sm"
                            className="h-8"
                            onClick={() => handlSizeChange(size.id)}
                        >
                            {size.label}
                        </Button>
                    ))}
            ...
            <div className="space-y-4">
                ...
                <RadioGroup defaultValue="" className="space-y-3" value={currentPrice} onValueChange={handlePriceChange}>
